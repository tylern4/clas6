...
void interpol_gol2(Short_t Wbin, Short_t a_l_bin, Short_t a_r_bin,
  ...
  // 1 -------------------
  sigma_inter = SIGMA_ARR_GOL2[Wbin][s23_left_bin][s12_left_bin][theta_left_bin]
                              [alpha_left_bin];
  ...
  sigma_tmp = SIGMA_ARR_GOL2[Wbin][s23_left_bin][s12_left_bin][theta_left_bin]
                            [alpha_right_bin];
  ...
  sigma_tmp = SIGMA_ARR_GOL2[Wbin][s23_left_bin][s12_left_bin][theta_right_bin]
                            [alpha_right_bin];
  sigma_tmp = sigma_tmp * fabs(S12_ARR_RIP3[s12_right_bin][Wbin] - s12);
  sigma_tmp = sigma_tmp * fabs(S23_ARR_RIP3[s23_right_bin][Wbin] - s23);
  ...
  sigma_tmp = SIGMA_ARR_GOL2[Wbin][s23_right_bin][s12_left_bin][theta_right_bin]
                            [alpha_right_bin];
  sigma_tmp = sigma_tmp * fabs(S12_ARR_RIP3[s12_right_bin][Wbin] - s12);
  ...
  sigma_tmp = SIGMA_ARR_GOL2[Wbin][s23_right_bin][s12_right_bin]
  ...
  sigma_tmp = SIGMA_ARR_GOL2[Wbin][s23_right_bin][s12_right_bin][theta_left_bin]
                            [alpha_left_bin];
  sigma_tmp = sigma_tmp * fabs(S12_ARR_RIP3[s12_left_bin][Wbin] - s12);
  sigma_tmp = sigma_tmp * fabs(S23_ARR_RIP3[s23_left_bin][Wbin] - s23);
  sigma_tmp = sigma_tmp * fabs(THETA_ARR[theta_right_bin] - theta);
  ...
  sigma_tmp = SIGMA_ARR_GOL2[Wbin][s23_left_bin][s12_right_bin][theta_left_bin]
                            [alpha_left_bin];
  sigma_tmp = sigma_tmp * fabs(S12_ARR_RIP3[s12_left_bin][Wbin] - s12);
  sigma_tmp = sigma_tmp * fabs(S23_ARR_RIP3[s23_right_bin][Wbin] - s23);
  sigma_tmp = sigma_tmp * fabs(THETA_ARR[theta_right_bin] - theta);
  ...
  sigma_tmp = SIGMA_ARR_GOL2[Wbin][s23_right_bin][s12_left_bin][theta_left_bin]
                            [alpha_left_bin];
  sigma_tmp = sigma_tmp * fabs(S12_ARR_RIP3[s12_right_bin][Wbin] - s12);
  sigma_tmp = sigma_tmp * fabs(S23_ARR_RIP3[s23_left_bin][Wbin] - s23);
  sigma_tmp = sigma_tmp * fabs(THETA_ARR[theta_right_bin] - theta);
  ...
  sigma_tmp = SIGMA_ARR_GOL2[Wbin][s23_left_bin][s12_right_bin][theta_right_bin]
                            [alpha_right_bin];
  sigma_tmp = sigma_tmp * fabs(S12_ARR_RIP3[s12_left_bin][Wbin] - s12);
  sigma_tmp = sigma_tmp * fabs(S23_ARR_RIP3[s23_right_bin][Wbin] - s23);
  sigma_tmp = sigma_tmp * fabs(THETA_ARR[theta_left_bin] - theta);
