...
void interpol_fedotov_thresh(Short_t dim, Short_t Q2bin, Short_t Wbin,
                             Short_t a_l_bin, Short_t a_r_bin, Short_t b_l_bin,
                             Short_t b_r_bin, Short_t c_l_bin, Short_t c_r_bin,
                             Short_t d_l_bin, Short_t d_r_bin, Float_t a,
  ...
  if (dim == 4) {
    ...
    Float_t factor;
    factor = 1. / fabs(S12_ARR_FED_THRESH[s12_right_bin][Wbin] -
                       S12_ARR_FED_THRESH[s12_left_bin][Wbin]);
    factor = factor / fabs(S23_ARR_FED_THRESH[s23_right_bin][Wbin] -
                           S23_ARR_FED_THRESH[s23_left_bin][Wbin]);
    ...
    // 1 -------------------
    sigma_inter =
        SIGMA_ARR_FED_THRESH[flag_sigma][Q2bin][Wbin][s23_left_bin]
                            [s12_left_bin][theta_left_bin][alpha_left_bin];
    sigma_inter =
        sigma_inter * fabs(S12_ARR_FED_THRESH[s12_right_bin][Wbin] - s12);
    sigma_inter =
        sigma_inter * fabs(S23_ARR_FED_THRESH[s23_right_bin][Wbin] - s23);
    ...
    sigma_tmp =
        SIGMA_ARR_FED_THRESH[flag_sigma][Q2bin][Wbin][s23_right_bin]
                            [s12_left_bin][theta_right_bin][alpha_right_bin];
    sigma_tmp = sigma_tmp * fabs(S12_ARR_FED_THRESH[s12_right_bin][Wbin] - s12);
    ...
    // cout
    // <<SIGMA_ARR_FED_THRESH[flag_sigma][Q2bin][Wbin][s23_left_bin][s12_right_bin][theta_right_bin][alpha_left_bin]<<"\n";
  }
