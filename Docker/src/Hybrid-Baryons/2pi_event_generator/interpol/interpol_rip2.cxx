...
void interpol_rip2(Short_t dim, Short_t Wbin, Short_t a_l_bin, Short_t a_r_bin,
  ...
  if (dim == 4) {
    ...
    Float_t factor;
    factor = 1. / fabs(S12_ARR_RIP2[s12_right_bin][Wbin] -
                       S12_ARR_RIP2[s12_left_bin][Wbin]);
    factor = factor / fabs(S23_ARR_RIP2[s23_right_bin][Wbin] -
                           S23_ARR_RIP2[s23_left_bin][Wbin]);
    factor =
    ...
    // 1 -------------------
    sigma_inter = SIGMA_ARR_RIP2[flag_sigma][Wbin][s23_left_bin][s12_left_bin]
    ...
    // cout << Wbin<< " "<<
    // SIGMA_ARR_RIP2[0][Wbin][s23_left_bin][s12_left_bin][theta_left_bin][alpha_left_bin]
    // <<" "<<sigma_inter <<  "\n";  2 ---------------------------

    Float_t sigma_tmp;

    sigma_tmp = SIGMA_ARR_RIP2[flag_sigma][Wbin][s23_left_bin][s12_left_bin]
    ...
    sigma_tmp = SIGMA_ARR_RIP2[flag_sigma][Wbin][s23_right_bin][s12_left_bin]
                              [theta_right_bin][alpha_right_bin];
    sigma_tmp = sigma_tmp * fabs(S12_ARR_RIP2[s12_right_bin][Wbin] - s12);
    ...
    sigma_tmp = SIGMA_ARR_RIP2[flag_sigma][Wbin][s23_right_bin][s12_right_bin]
                              [theta_right_bin][alpha_right_bin];
    ...
    sigma_tmp = SIGMA_ARR_RIP2[flag_sigma][Wbin][s23_left_bin][s12_right_bin]
                              [theta_left_bin][alpha_left_bin];
    sigma_tmp = sigma_tmp * fabs(S12_ARR_RIP2[s12_left_bin][Wbin] - s12);
    sigma_tmp = sigma_tmp * fabs(S23_ARR_RIP2[s23_right_bin][Wbin] - s23);
    sigma_tmp = sigma_tmp * fabs(THETA_ARR[theta_right_bin] - theta);
    ...
    // 14"<<SIGMA_ARR_RIP2[flag_sigma][Wbin][s23_right_bin][s12_left_bin][theta_right_bin][alpha_left_bin]<<"
    // 13"<<
    // SIGMA_ARR_RIP2[flag_sigma][Wbin][s23_left_bin][s12_right_bin][theta_right_bin][alpha_right_bin]<<"
    // 12"<<  " interpol \n";
  }
