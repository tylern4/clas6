...
if ((anglegen >= 0.01) && (anglegen <= anglemax - 0.01)) return int((anglegen -
0.01)/((anglemax  - 0.02)/13.));
...
void get_xsect_gol2(Float_t Wgen, Float_t s12gen, Float_t s23gen,
  ...
  interpol_gol2(Wright_bin, s12left_wright_bin, s12right_wright_bin,
                s23left_wright_bin, s23right_wright_bin, thetaleft_bin,
                thetaright_bin, alphaleft_bin, alpharight_bin, s12gen, s23gen,
                thetagen, alphagen, sigma_wright_gol);

  interpol_gol2(Wleft_bin, s12left_wleft_bin, s12right_wleft_bin,
                s23left_wleft_bin, s23right_wleft_bin, thetaleft_bin,
                thetaright_bin, alphaleft_bin, alpharight_bin, s12gen, s23gen,
                thetagen, alphagen, sigma_wleft_gol);
