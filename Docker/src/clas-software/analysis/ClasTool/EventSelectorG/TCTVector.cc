...
TCTVector::TCTVector (const char *name,const char *oper)
{
  fVECT_Name  = name;
...
void           TCTVector::Construct(TLorentzVector  *vl_buff, int n_vec)
{
  fVect = vl_buff[0];
  for(int i=1;i<n_vec;i++) fVect += vl_buff[i]; 
}
