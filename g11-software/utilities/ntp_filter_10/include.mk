...
# Linux
ifeq (Linux, $(OSNAME))
  ifeq (LinuxRHFC8, $(OS_NAME))
     COMPILER = gfortran
     F77OPT += -fno-automatic -fPIC
     F77OPT += -ffixed-line-length-none
     F77OPT += -fno-second-underscore
   else
     COMPILER = f77
     F77OPT   =  -mcpu=i486 -fno-automatic -finit-local-zero
