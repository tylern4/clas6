...
void pHEAD(FILE *fp,clasHEAD_t *header)
{
  fprintf(fp,"\nVersion:\t%d\nRun:\t\t%d\nEvent:\t\t%d\nType:\t\t%d\nROC:\t\t%d\nCLASS:\t\t%d\nTrgbit:\t\t0x%x\nTIME:\t\t%s\n",header->head[0].version,header->head[0].nrun,
          header->head[0].nevent,header->head[0].type,header->head[0].roc,
...
{
  fprintf(fp,"sync: %d  C22AI: %d  C22AX: %d  C22AY: %d  C24AI: %d  C24AX: %d  C24AY: %d  FCI: %d  PMT1: %d  PMT2: %d  PMT3: %d  PMT4: %d  \n", hls->sync, hls->c22ai, hls->c22ax, hls->c22ay, hls->c24ai, hls->c24ax, hls->c24ay, hls->fci, hls->pmt1, hls->pmt2, hls->pmt3, hls->pmt4);
}
