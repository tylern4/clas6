...
int ec_read_adc_map_(int *runno, float ec_common[NSEC][EC_LAYERS][EC_ORIENTATION][EC_STRIPS], char *subsystem_f, int string){
...
/* Generic read routine - does not fill the common directly*/
int ec_read_map_(int *runno, float ec_common[NSEC][EC_LAYERS][EC_ORIENTATION][EC_STRIPS], char *subsystem_f, int string){
...
/* Generic read routine - does not fill the common directly*/
int ec_read_map(int runno, float ec_common[NSEC][EC_LAYERS][EC_ORIENTATION][EC_STRIPS], char *subsystem_c){
...
int ec_read_adc_map(int runno, float ec_common[NSEC][EC_LAYERS][EC_ORIENTATION][EC_STRIPS], char *subsystem_c)
{
  int isec,istrip;
  int i, firsttime;
  char *dir, def_map[100];
...
int ec_read_tdc_map(int runno, float ec_common[NSEC][EC_LAYERS-1][EC_ORIENTATION][EC_STRIPS], char *subsystem_c)
{
...
int ec_read_tdc_map_(int *runno, float ec_common[NSEC][EC_LAYERS-1][EC_ORIENTATION][EC_STRIPS], char *subsystem_f, int string)
{
  int sector, strip, layer, orientation;
  int i, firsttime, item_id;
  char *dir, def_map[100], subsystem_c[50], item[16];
  float values[EC_CHANNELS_PER_LAYER];
...
int ec_put_tdc_map_(int *runno, float ec_common[6][2][3][36], char *subsystem_f, int string)
{
  ...
  for (layer=INNER; layer<EC_LAYERS; layer++) {
	...
	for (channel=0; channel<EC_STRIPS; channel++) {
