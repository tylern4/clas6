...
char *csql_calibddl_env;
 ...
 csql_db_database_env      = (char *) getenv("CSQL_DB");
 csql_db_databasehost_env  = (char *) getenv("CSQL_DBHOST");
 csql_db_username_env      = (char *) getenv("CSQL_USER");
 csql_db_databasetable_env = (char *) getenv("CSQL_TABLE");
 csql_db_comment_env       = (char *) getenv("CSQL_COMM");
 csql_ddlfilename_env      = (char *) getenv("CSQL_DDL");
 csql_calibddl_env         = (char *) getenv("CSQL_CALIB");
...
void init_env()
{
  ...
  calib_hostname_env   = (char *) getenv("CLAS_CALDB_HOST");
  calib_runindex_env   = (char *) getenv("CLAS_CALDB_RUNINDEX");
  calib_timestamp_env  = (char *) getenv("CLAS_CALDB_TIME");
