/* -=======================================================- *
$Id: kinematics.h,v 1.16 2001/07/20 20:18:13 mcaleer Exp $
$Author: mcaleer $
$Revision: 1.16 $
$Date: 2001/07/20 20:18:13 $
* -=======================================================- */
/*
*
*  kinematics.h
...
vector4_t lab2hel4vg(vector4_t meson,vector4_t beam,vector4_t tgt,vector4_t lab_vec);
...
float costheta_gj(vector4_t decay, vector4_t beam, vector4_t product, vector4_t target, 
		  vector4_t recoil);
float phi_ty(vector4_t decay, vector4_t beam, vector4_t product, vector4_t target, 
	     vector4_t recoil);
float phi_ty_deg(vector4_t decay, vector4_t beam, vector4_t product, vector4_t target, 
		 vector4_t recoil);
float costheta_cm(vector4_t rest, vector4_t analyzer);
