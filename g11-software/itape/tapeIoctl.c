...
static const char sccsid[] = "@(#)"__FILE__"\t$Revision: 1.1 $\tCreated $Date: 1999/04/08 17:43:18 $ , \tcompiled "__DATE__;
...
#if (defined(sgi)||defined(_AIX)||defined(DECUNIX)||defined(linux)||defined(__sun))
