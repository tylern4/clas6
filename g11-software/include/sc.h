...
#define SC_TDC_MAX 4095
#define SC_TIME_OVERFLOW 100000.0
#define SC_TIME_UNDERFLOW -100000.0
...
typedef struct {
  float left[SC_NPADDLES];
  float right[SC_NPADDLES];
} sc_const_t;

typedef struct {
  int left[SC_NPADDLES];
  int right[SC_NPADDLES];
} sc_int_const_t;
