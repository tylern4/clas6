...
public:
  ...
  float get_mm_pip_pim(int row) {
    return ((row_ptr+row)->mm_pip_pim);
  }
  float get_smm_pip_pim(int row) {
    return ((row_ptr+row)->smm_pip_pim);
  }
...
public:
  ...
  int get_Nepiphp(int row) {
    return ((row_ptr+row)->Nepiphp);
  }
  int get_Npiphn(int row) {
    return ((row_ptr+row)->Npiphn);
  }
  int get_Ngamma(int row) {
    return ((row_ptr+row)->Ngamma);
  }
  int get_Ng_norm(int row) {
    return ((row_ptr+row)->Ng_norm);
  }
};
...
public:
  ...
  float get_Tclmax(int row) {
    return ((row_ptr+row)->Tclmax);
  }
  ...
  float get_zclmax(int row) {
    return ((row_ptr+row)->zclmax);
  }
  float get_res1(int row) {
    return ((row_ptr+row)->res1);
  }
  float get_res2(int row) {
    return ((row_ptr+row)->res2);
  }
  float get_res3(int row) {
