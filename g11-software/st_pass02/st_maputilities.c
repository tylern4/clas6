...
int stncal_read_map_(int *runno,float StnCal_values[24][13],float StnCal_uncs[24][13]){
  char *dir,map[100];
  ...
  for (i=0;i<24;i++){
    ...
    StnCal_values[i][VEFF_LEG_NEAR]=veff_leg[i];
    StnCal_values[i][VEFF_NOSE_NEAR]=veff_nose[i];
