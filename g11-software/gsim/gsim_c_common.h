...
#define MAX_DETECTOR (14)

enum DETECTOR_ELEMENT  {ALL,CC,DC,EC,EC1,SC,ST,TORU,MINI,FOIL,PTG,TG,TG2,OTHER};
...
typedef struct { /*  clmate */ 
  ...
  int imate_cerexmyl;       /* cerex/alum.mylar compound (25:22)  */
  int imate_lowdform;       /* low density foam for scattering chamber */
...
/* ------ Start of file gsimflags.inc */

typedef struct { /*  gsimflags */ 
  int nobosout;
}GSIMFLAGS_t ; 

/* ------ End of file gsimflags.inc */
