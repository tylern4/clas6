...
typedef struct {
  ...
  int ipar_trk_magtyp,ipar_trk_bgridtyp;
  int ipar_torus_current, ipar_minitorus_current;
  int ipar_poltarget_current;
  int ipar_Bsign_torus;
  int ipar_trk_statistics, ipar_trk_level;
  int ipar_trk_sector,  ipar_trk_mintracks;
  int ipar_trk_minhits[6];
  int ipar_trk_maxsegm, ipar_trk_startlink;
  int ipar_trk_minlinks, ipar_trk_minlramb;
  int ipar_trk_beta1_part;
  int ipar_trk_make_prlink;
  int ipar_trk_multscat, ipar_trk_maxiter;
  int ipar_trk_VXconstr;
  int ipar_trk_calcTM;
  int ipar_trk_print[8];
  int ipar_trk_histo, ipar_trk_ntuple;
  int ipar_trk_region1;
  int ipar_trk_lramb;
  int ipar_ntswitch;
  int ipar_reg1_use_dhcl,ipar_reg1_min,ipar_reg1_max;
