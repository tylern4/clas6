...
ifdef ONLINE
    ...
    RECSIS_MD_LIBS += ana nsl kernlib mysqlclient m nsl socket gcc
#    RECSIS_SHARED_LIBS += -lposix4 -lC -lresolv
    RECSIS_SHARED_LIBS += -lposix4 -lresolv
else
    RECSIS_MD_LIBS =  ana fputil$(ADD_DEBUG) bos$(ADD_DEBUG) fpack$(ADD_DEBUG) packlib nsl socket
endif
