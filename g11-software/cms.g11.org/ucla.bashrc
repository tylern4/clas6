...
then
  ...
  case $1 in
    ...
    -old)
	export CLAS_BUILD=$BUILDS/release-2-3
	export CLAS_PARMS=$CLAS_ROOT/parms
        export HV_LOCATION=$CLAS_BUILD/packages/Hv
	echo "ancient: release-2-3 libraries";;
...
alias use_dev='.  $CLAS_BUILD/packages/cms/ucla.bashrc -d'
alias use_prod='. $CLAS_BUILD/packages/cms/ucla.bashrc -p3'
alias use_late='. $CLAS_BUILD/packages/cms/ucla.bashrc -l'
alias use_old='. $CLAS_BUILD/packages/cms/ucla.bashrc -old'
