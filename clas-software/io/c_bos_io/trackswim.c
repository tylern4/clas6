...
/**
 * check field on/off status. return value: 0 - off, !0 - on
 *
...
/**
 * get the magnetic field at a specific point V
 * and put it into vector B
 **/
...
float DotProduct3(const vector3_t *a, const vector3_t *b) {
