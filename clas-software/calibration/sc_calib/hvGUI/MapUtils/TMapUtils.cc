...
TMapUtils::TMapUtils(const char *dbHOSTNAME, const char *dbDATABASE,const char *dbUSERNAME, char *fRun_INDEX_Table2){
  // 
...
//SetDbVersion("DEV");
 //fRun_INDEX_Table = "RunIndex";
 //cout<<"PLEASE ENTER A RUN INDEX NAME:"<<endl;
 //cin>>fRun_INDEX_Table;
   fRun_INDEX_Table = fRun_INDEX_Table2;
   cout<<"USING RUN INDEX:"<<fRun_INDEX_Table<<endl;
