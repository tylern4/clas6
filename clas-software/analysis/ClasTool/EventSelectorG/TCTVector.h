...
public:
  ...
  TCTVector (const char *name,const char *oper);
...
~TCTVector ();
 ...
 TString  GetOperation(){return fOperation;};

 TLorentzVector GetV();
 TLorentzVector Vect(){return fVect;};

 void           Construct(TLorentzVector  *vl_buff, int n_vec);
