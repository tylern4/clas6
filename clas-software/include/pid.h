...
int get_avg_tof_tpho(clasBID_t *BID, int trk_level, float* tof_avg_tpho_p, float* tof_avg_tprop_p);
int get_avg_st_tpho(int nBID, bid_t* bid, int trk_level, float* tof_avg_tpho_p, float* tof_avg_tprop_p);
