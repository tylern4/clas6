...
struct CALB_row {
  ...
  float meanSTpd8prot;
  float meanSTpd9prot;
  float meanSTpd10prot;
  float meanSTpd11prot;
  float meanSTpd12prot;
  float meanSTpd13prot;
  float meanSTpd14prot;
  float meanSTpd15prot;
  float meanSTpd16prot;
  float meanSTpd17prot;
  float meanSTpd18prot;
  float meanSTpd19prot;
  float meanSTpd20prot;
  float meanSTpd21prot;
  float meanSTpd22prot;
  float meanSTpd23prot;
  float meanSTpd24prot;
  float sigmaSTpd1prot;
  float sigmaSTpd2prot;
  float sigmaSTpd3prot;
  float sigmaSTpd4prot;
  float sigmaSTpd5prot;
  float sigmaSTpd6prot;
  float sigmaSTpd7prot;
  float sigmaSTpd8prot;
  float sigmaSTpd9prot;
  float sigmaSTpd10prot;
  float sigmaSTpd11prot;
  float sigmaSTpd12prot;
  float sigmaSTpd13prot;
  float sigmaSTpd14prot;
  float sigmaSTpd15prot;
  float sigmaSTpd16prot;
  float sigmaSTpd17prot;
  float sigmaSTpd18prot;
  float sigmaSTpd19prot;
  float sigmaSTpd20prot;
  float sigmaSTpd21prot;
  float sigmaSTpd22prot;
  float sigmaSTpd23prot;
  float sigmaSTpd24prot;
  float meanSTpd1pip;
  float meanSTpd2pip;
  float meanSTpd3pip;
  float meanSTpd4pip;
  ...
  float sigmaSTpd8pip;
  float sigmaSTpd9pip;
  float sigmaSTpd10pip;
  float sigmaSTpd11pip;
  float sigmaSTpd12pip;
  float sigmaSTpd13pip;
  float sigmaSTpd14pip;
  float sigmaSTpd15pip;
  float sigmaSTpd16pip;
  float sigmaSTpd17pip;
  float sigmaSTpd18pip;
  float sigmaSTpd19pip;
  float sigmaSTpd20pip;
  float sigmaSTpd21pip;
  float sigmaSTpd22pip;
  float sigmaSTpd23pip;
  float sigmaSTpd24pip;
  float meanSTpd1pim;
  float meanSTpd2pim;
  float meanSTpd3pim;
  float meanSTpd4pim;
  ...
  float sigmaSTpd8pim;
  float sigmaSTpd9pim;
  float sigmaSTpd10pim;
  float sigmaSTpd11pim;
  float sigmaSTpd12pim;
  float sigmaSTpd13pim;
  float sigmaSTpd14pim;
  float sigmaSTpd15pim;
  float sigmaSTpd16pim;
  float sigmaSTpd17pim;
  float sigmaSTpd18pim;
  float sigmaSTpd19pim;
  float sigmaSTpd20pim;
  float sigmaSTpd21pim;
  float sigmaSTpd22pim;
  float sigmaSTpd23pim;
  float sigmaSTpd24pim;
  float meanECprot;
  float sigmaECprot;
  float meanECpip;
  float sigmaECpip;
...
public:
  ...
  float get_meanRFgoodtag(int row) {
    return ((row_ptr+row)->meanRFgoodtag);
  }
  float get_sigmaRFgoodtag(int row) {
    return ((row_ptr+row)->sigmaRFgoodtag);
  }
  float get_meanRFalltag(int row) {
    return ((row_ptr+row)->meanRFalltag);
  }
  float get_sigmaRFalltag(int row) {
    return ((row_ptr+row)->sigmaRFalltag);
  }
  float get_meanRFprot(int row) {
    return ((row_ptr+row)->meanRFprot);
  }
  float get_sigmaRFprot(int row) {
    return ((row_ptr+row)->sigmaRFprot);
  }
  float get_meanRFpip(int row) {
    return ((row_ptr+row)->meanRFpip);
  }
  float get_sigmaRFpip(int row) {
    return ((row_ptr+row)->sigmaRFpip);
  }
  float get_meanRFpim(int row) {
    return ((row_ptr+row)->meanRFpim);
  }
  float get_sigmaRFpim(int row) {
    return ((row_ptr+row)->sigmaRFpim);
  }
  float get_meanSTprot(int row) {
    return ((row_ptr+row)->meanSTprot);
  }
  float get_sigmaSTprot(int row) {
    return ((row_ptr+row)->sigmaSTprot);
  }
  float get_meanSTpip(int row) {
    return ((row_ptr+row)->meanSTpip);
  }
  float get_sigmaSTpip(int row) {
    return ((row_ptr+row)->sigmaSTpip);
  }
  float get_meanSTpim(int row) {
    return ((row_ptr+row)->meanSTpim);
  }
  float get_sigmaSTpim(int row) {
    return ((row_ptr+row)->sigmaSTpim);
  }
  float get_meanSTpd1prot(int row) {
    return ((row_ptr+row)->meanSTpd1prot);
  }
  float get_meanSTpd2prot(int row) {
    return ((row_ptr+row)->meanSTpd2prot);
  }
  float get_meanSTpd3prot(int row) {
    return ((row_ptr+row)->meanSTpd3prot);
  }
  float get_meanSTpd4prot(int row) {
    return ((row_ptr+row)->meanSTpd4prot);
  }
  float get_meanSTpd5prot(int row) {
    return ((row_ptr+row)->meanSTpd5prot);
  }
  float get_meanSTpd6prot(int row) {
    return ((row_ptr+row)->meanSTpd6prot);
  }
  float get_meanSTpd7prot(int row) {
    return ((row_ptr+row)->meanSTpd7prot);
  }
  float get_meanSTpd8prot(int row) {
    return ((row_ptr+row)->meanSTpd8prot);
  }
  float get_meanSTpd9prot(int row) {
    return ((row_ptr+row)->meanSTpd9prot);
  }
  float get_meanSTpd10prot(int row) {
    return ((row_ptr+row)->meanSTpd10prot);
  }
  float get_meanSTpd11prot(int row) {
    return ((row_ptr+row)->meanSTpd11prot);
  }
  float get_meanSTpd12prot(int row) {
    return ((row_ptr+row)->meanSTpd12prot);
  }
  float get_meanSTpd13prot(int row) {
    return ((row_ptr+row)->meanSTpd13prot);
  }
  float get_meanSTpd14prot(int row) {
    return ((row_ptr+row)->meanSTpd14prot);
  }
  float get_meanSTpd15prot(int row) {
    return ((row_ptr+row)->meanSTpd15prot);
  }
  float get_meanSTpd16prot(int row) {
    return ((row_ptr+row)->meanSTpd16prot);
  }
  float get_meanSTpd17prot(int row) {
    return ((row_ptr+row)->meanSTpd17prot);
  }
  float get_meanSTpd18prot(int row) {
    return ((row_ptr+row)->meanSTpd18prot);
  }
  float get_meanSTpd19prot(int row) {
    return ((row_ptr+row)->meanSTpd19prot);
  }
  float get_meanSTpd20prot(int row) {
    return ((row_ptr+row)->meanSTpd20prot);
  }
  float get_meanSTpd21prot(int row) {
    return ((row_ptr+row)->meanSTpd21prot);
  }
  float get_meanSTpd22prot(int row) {
    return ((row_ptr+row)->meanSTpd22prot);
  }
  float get_meanSTpd23prot(int row) {
    return ((row_ptr+row)->meanSTpd23prot);
  }
  float get_meanSTpd24prot(int row) {
    return ((row_ptr+row)->meanSTpd24prot);
  }
  float get_sigmaSTpd1prot(int row) {
    return ((row_ptr+row)->sigmaSTpd1prot);
  }
  float get_sigmaSTpd2prot(int row) {
    return ((row_ptr+row)->sigmaSTpd2prot);
  }
  float get_sigmaSTpd3prot(int row) {
    return ((row_ptr+row)->sigmaSTpd3prot);
  }
  float get_sigmaSTpd4prot(int row) {
    return ((row_ptr+row)->sigmaSTpd4prot);
  }
  float get_sigmaSTpd5prot(int row) {
    return ((row_ptr+row)->sigmaSTpd5prot);
  }
  float get_sigmaSTpd6prot(int row) {
    return ((row_ptr+row)->sigmaSTpd6prot);
  }
  float get_sigmaSTpd7prot(int row) {
    return ((row_ptr+row)->sigmaSTpd7prot);
  }
  float get_sigmaSTpd8prot(int row) {
    return ((row_ptr+row)->sigmaSTpd8prot);
  }
  float get_sigmaSTpd9prot(int row) {
    return ((row_ptr+row)->sigmaSTpd9prot);
  }
  float get_sigmaSTpd10prot(int row) {
    return ((row_ptr+row)->sigmaSTpd10prot);
  }
  float get_sigmaSTpd11prot(int row) {
    return ((row_ptr+row)->sigmaSTpd11prot);
  }
  float get_sigmaSTpd12prot(int row) {
    return ((row_ptr+row)->sigmaSTpd12prot);
  }
  float get_sigmaSTpd13prot(int row) {
    return ((row_ptr+row)->sigmaSTpd13prot);
  }
  float get_sigmaSTpd14prot(int row) {
    return ((row_ptr+row)->sigmaSTpd14prot);
  }
  float get_sigmaSTpd15prot(int row) {
    return ((row_ptr+row)->sigmaSTpd15prot);
  }
  float get_sigmaSTpd16prot(int row) {
    return ((row_ptr+row)->sigmaSTpd16prot);
  }
  float get_sigmaSTpd17prot(int row) {
    return ((row_ptr+row)->sigmaSTpd17prot);
  }
  float get_sigmaSTpd18prot(int row) {
    return ((row_ptr+row)->sigmaSTpd18prot);
  }
  float get_sigmaSTpd19prot(int row) {
    return ((row_ptr+row)->sigmaSTpd19prot);
  }
  float get_sigmaSTpd20prot(int row) {
    return ((row_ptr+row)->sigmaSTpd20prot);
  }
  float get_sigmaSTpd21prot(int row) {
    return ((row_ptr+row)->sigmaSTpd21prot);
  }
  float get_sigmaSTpd22prot(int row) {
    return ((row_ptr+row)->sigmaSTpd22prot);
  }
  float get_sigmaSTpd23prot(int row) {
    return ((row_ptr+row)->sigmaSTpd23prot);
  }
  float get_sigmaSTpd24prot(int row) {
    return ((row_ptr+row)->sigmaSTpd24prot);
  }
  float get_meanSTpd1pip(int row) {
    return ((row_ptr+row)->meanSTpd1pip);
  }
  float get_meanSTpd2pip(int row) {
    return ((row_ptr+row)->meanSTpd2pip);
  }
  float get_meanSTpd3pip(int row) {
    return ((row_ptr+row)->meanSTpd3pip);
  }
  float get_meanSTpd4pip(int row) {
    return ((row_ptr+row)->meanSTpd4pip);
  }
  float get_meanSTpd5pip(int row) {
    return ((row_ptr+row)->meanSTpd5pip);
  }
  float get_meanSTpd6pip(int row) {
    return ((row_ptr+row)->meanSTpd6pip);
  }
  float get_meanSTpd7pip(int row) {
    return ((row_ptr+row)->meanSTpd7pip);
  }
  float get_meanSTpd8pip(int row) {
    return ((row_ptr+row)->meanSTpd8pip);
  }
  float get_meanSTpd9pip(int row) {
    return ((row_ptr+row)->meanSTpd9pip);
  }
  float get_meanSTpd10pip(int row) {
    return ((row_ptr+row)->meanSTpd10pip);
  }
  float get_meanSTpd11pip(int row) {
    return ((row_ptr+row)->meanSTpd11pip);
  }
  float get_meanSTpd12pip(int row) {
    return ((row_ptr+row)->meanSTpd12pip);
  }
  float get_meanSTpd13pip(int row) {
    return ((row_ptr+row)->meanSTpd13pip);
  }
  float get_meanSTpd14pip(int row) {
    return ((row_ptr+row)->meanSTpd14pip);
  }
  float get_meanSTpd15pip(int row) {
    return ((row_ptr+row)->meanSTpd15pip);
  }
  float get_meanSTpd16pip(int row) {
    return ((row_ptr+row)->meanSTpd16pip);
  }
  float get_meanSTpd17pip(int row) {
    return ((row_ptr+row)->meanSTpd17pip);
  }
  float get_meanSTpd18pip(int row) {
    return ((row_ptr+row)->meanSTpd18pip);
  }
  float get_meanSTpd19pip(int row) {
    return ((row_ptr+row)->meanSTpd19pip);
  }
  float get_meanSTpd20pip(int row) {
    return ((row_ptr+row)->meanSTpd20pip);
  }
  float get_meanSTpd21pip(int row) {
    return ((row_ptr+row)->meanSTpd21pip);
  }
  float get_meanSTpd22pip(int row) {
    return ((row_ptr+row)->meanSTpd22pip);
  }
  float get_meanSTpd23pip(int row) {
    return ((row_ptr+row)->meanSTpd23pip);
  }
  float get_meanSTpd24pip(int row) {
    return ((row_ptr+row)->meanSTpd24pip);
  }
  float get_sigmaSTpd1pip(int row) {
    return ((row_ptr+row)->sigmaSTpd1pip);
  }
  float get_sigmaSTpd2pip(int row) {
    return ((row_ptr+row)->sigmaSTpd2pip);
  }
  float get_sigmaSTpd3pip(int row) {
    return ((row_ptr+row)->sigmaSTpd3pip);
  }
  float get_sigmaSTpd4pip(int row) {
    return ((row_ptr+row)->sigmaSTpd4pip);
  }
  float get_sigmaSTpd5pip(int row) {
    return ((row_ptr+row)->sigmaSTpd5pip);
  }
  float get_sigmaSTpd6pip(int row) {
    return ((row_ptr+row)->sigmaSTpd6pip);
  }
  float get_sigmaSTpd7pip(int row) {
    return ((row_ptr+row)->sigmaSTpd7pip);
  }
  float get_sigmaSTpd8pip(int row) {
    return ((row_ptr+row)->sigmaSTpd8pip);
  }
  float get_sigmaSTpd9pip(int row) {
    return ((row_ptr+row)->sigmaSTpd9pip);
  }
  float get_sigmaSTpd10pip(int row) {
    return ((row_ptr+row)->sigmaSTpd10pip);
  }
  float get_sigmaSTpd11pip(int row) {
    return ((row_ptr+row)->sigmaSTpd11pip);
  }
  float get_sigmaSTpd12pip(int row) {
    return ((row_ptr+row)->sigmaSTpd12pip);
  }
  float get_sigmaSTpd13pip(int row) {
    return ((row_ptr+row)->sigmaSTpd13pip);
  }
  float get_sigmaSTpd14pip(int row) {
    return ((row_ptr+row)->sigmaSTpd14pip);
  }
  float get_sigmaSTpd15pip(int row) {
    return ((row_ptr+row)->sigmaSTpd15pip);
  }
  float get_sigmaSTpd16pip(int row) {
    return ((row_ptr+row)->sigmaSTpd16pip);
  }
  float get_sigmaSTpd17pip(int row) {
    return ((row_ptr+row)->sigmaSTpd17pip);
  }
  float get_sigmaSTpd18pip(int row) {
    return ((row_ptr+row)->sigmaSTpd18pip);
  }
  float get_sigmaSTpd19pip(int row) {
    return ((row_ptr+row)->sigmaSTpd19pip);
  }
  float get_sigmaSTpd20pip(int row) {
    return ((row_ptr+row)->sigmaSTpd20pip);
  }
  float get_sigmaSTpd21pip(int row) {
    return ((row_ptr+row)->sigmaSTpd21pip);
  }
  float get_sigmaSTpd22pip(int row) {
    return ((row_ptr+row)->sigmaSTpd22pip);
  }
  float get_sigmaSTpd23pip(int row) {
    return ((row_ptr+row)->sigmaSTpd23pip);
  }
  float get_sigmaSTpd24pip(int row) {
    return ((row_ptr+row)->sigmaSTpd24pip);
  }
  float get_meanSTpd1pim(int row) {
    return ((row_ptr+row)->meanSTpd1pim);
  }
  float get_meanSTpd2pim(int row) {
    return ((row_ptr+row)->meanSTpd2pim);
  }
  float get_meanSTpd3pim(int row) {
    return ((row_ptr+row)->meanSTpd3pim);
  }
  float get_meanSTpd4pim(int row) {
    return ((row_ptr+row)->meanSTpd4pim);
  }
  float get_meanSTpd5pim(int row) {
    return ((row_ptr+row)->meanSTpd5pim);
  }
  float get_meanSTpd6pim(int row) {
    return ((row_ptr+row)->meanSTpd6pim);
  }
  float get_meanSTpd7pim(int row) {
    return ((row_ptr+row)->meanSTpd7pim);
  }
  float get_meanSTpd8pim(int row) {
    return ((row_ptr+row)->meanSTpd8pim);
  }
  float get_meanSTpd9pim(int row) {
    return ((row_ptr+row)->meanSTpd9pim);
  }
  float get_meanSTpd10pim(int row) {
    return ((row_ptr+row)->meanSTpd10pim);
  }
  float get_meanSTpd11pim(int row) {
    return ((row_ptr+row)->meanSTpd11pim);
  }
  float get_meanSTpd12pim(int row) {
    return ((row_ptr+row)->meanSTpd12pim);
  }
  float get_meanSTpd13pim(int row) {
    return ((row_ptr+row)->meanSTpd13pim);
  }
  float get_meanSTpd14pim(int row) {
    return ((row_ptr+row)->meanSTpd14pim);
  }
  float get_meanSTpd15pim(int row) {
    return ((row_ptr+row)->meanSTpd15pim);
  }
  float get_meanSTpd16pim(int row) {
    return ((row_ptr+row)->meanSTpd16pim);
  }
  float get_meanSTpd17pim(int row) {
    return ((row_ptr+row)->meanSTpd17pim);
  }
  float get_meanSTpd18pim(int row) {
    return ((row_ptr+row)->meanSTpd18pim);
  }
  float get_meanSTpd19pim(int row) {
    return ((row_ptr+row)->meanSTpd19pim);
  }
  float get_meanSTpd20pim(int row) {
    return ((row_ptr+row)->meanSTpd20pim);
  }
  float get_meanSTpd21pim(int row) {
    return ((row_ptr+row)->meanSTpd21pim);
  }
  float get_meanSTpd22pim(int row) {
    return ((row_ptr+row)->meanSTpd22pim);
  }
  float get_meanSTpd23pim(int row) {
    return ((row_ptr+row)->meanSTpd23pim);
  }
  float get_meanSTpd24pim(int row) {
    return ((row_ptr+row)->meanSTpd24pim);
  }
  float get_sigmaSTpd1pim(int row) {
    return ((row_ptr+row)->sigmaSTpd1pim);
  }
  float get_sigmaSTpd2pim(int row) {
    return ((row_ptr+row)->sigmaSTpd2pim);
  }
  float get_sigmaSTpd3pim(int row) {
    return ((row_ptr+row)->sigmaSTpd3pim);
  }
  float get_sigmaSTpd4pim(int row) {
    return ((row_ptr+row)->sigmaSTpd4pim);
  }
  float get_sigmaSTpd5pim(int row) {
    return ((row_ptr+row)->sigmaSTpd5pim);
  }
  float get_sigmaSTpd6pim(int row) {
    return ((row_ptr+row)->sigmaSTpd6pim);
  }
  float get_sigmaSTpd7pim(int row) {
    return ((row_ptr+row)->sigmaSTpd7pim);
  }
  float get_sigmaSTpd8pim(int row) {
    return ((row_ptr+row)->sigmaSTpd8pim);
  }
  float get_sigmaSTpd9pim(int row) {
    return ((row_ptr+row)->sigmaSTpd9pim);
  }
  float get_sigmaSTpd10pim(int row) {
    return ((row_ptr+row)->sigmaSTpd10pim);
  }
  float get_sigmaSTpd11pim(int row) {
    return ((row_ptr+row)->sigmaSTpd11pim);
  }
  float get_sigmaSTpd12pim(int row) {
    return ((row_ptr+row)->sigmaSTpd12pim);
  }
  float get_sigmaSTpd13pim(int row) {
    return ((row_ptr+row)->sigmaSTpd13pim);
  }
  float get_sigmaSTpd14pim(int row) {
    return ((row_ptr+row)->sigmaSTpd14pim);
  }
  float get_sigmaSTpd15pim(int row) {
    return ((row_ptr+row)->sigmaSTpd15pim);
  }
  float get_sigmaSTpd16pim(int row) {
    return ((row_ptr+row)->sigmaSTpd16pim);
  }
  float get_sigmaSTpd17pim(int row) {
    return ((row_ptr+row)->sigmaSTpd17pim);
  }
  float get_sigmaSTpd18pim(int row) {
    return ((row_ptr+row)->sigmaSTpd18pim);
  }
  float get_sigmaSTpd19pim(int row) {
    return ((row_ptr+row)->sigmaSTpd19pim);
  }
  float get_sigmaSTpd20pim(int row) {
    return ((row_ptr+row)->sigmaSTpd20pim);
  }
  float get_sigmaSTpd21pim(int row) {
    return ((row_ptr+row)->sigmaSTpd21pim);
  }
  float get_sigmaSTpd22pim(int row) {
    return ((row_ptr+row)->sigmaSTpd22pim);
  }
  float get_sigmaSTpd23pim(int row) {
    return ((row_ptr+row)->sigmaSTpd23pim);
  }
  float get_sigmaSTpd24pim(int row) {
    return ((row_ptr+row)->sigmaSTpd24pim);
  }
  float get_meanECprot(int row) {
    return ((row_ptr+row)->meanECprot);
  }
  float get_sigmaECprot(int row) {
    return ((row_ptr+row)->sigmaECprot);
  }
  float get_meanECpip(int row) {
    return ((row_ptr+row)->meanECpip);
  }
  float get_sigmaECpip(int row) {
    return ((row_ptr+row)->sigmaECpip);
  }
  float get_meanECpim(int row) {
    return ((row_ptr+row)->meanECpim);
  }
  float get_sigmaECpim(int row) {
    return ((row_ptr+row)->sigmaECpim);
  }
  float get_meanECt(int row) {
    return ((row_ptr+row)->meanECt);
  }
  float get_sigmaECt(int row) {
    return ((row_ptr+row)->sigmaECt);
  }
  float get_meanECb(int row) {
    return ((row_ptr+row)->meanECb);
  }
  float get_sigmaECb(int row) {
    return ((row_ptr+row)->sigmaECb);
  }
  float get_meanECm(int row) {
    return ((row_ptr+row)->meanECm);
  }
  float get_sigmaECm(int row) {
    return ((row_ptr+row)->sigmaECm);
  }
  float get_nECm(int row) {
    return ((row_ptr+row)->nECm);
  }
  float get_xbeam(int row) {
    return ((row_ptr+row)->xbeam);
  }
  float get_ybeam(int row) {
    return ((row_ptr+row)->ybeam);
  }
  float get_sig_xbeam(int row) {
    return ((row_ptr+row)->sig_xbeam);
  }
  float get_sig_ybeam(int row) {
    return ((row_ptr+row)->sig_ybeam);
  }
  float get_pimasstof(int row) {
    return ((row_ptr+row)->pimasstof);
  }
  float get_sigpimasstof(int row) {
    return ((row_ptr+row)->sigpimasstof);
  }
  float get_npimasstof(int row) {
    return ((row_ptr+row)->npimasstof);
  }
  float get_protmasstof(int row) {
    return ((row_ptr+row)->protmasstof);
  }
  float get_sigprotmasstof(int row) {
    return ((row_ptr+row)->sigprotmasstof);
  }
  float get_nprotmasstof(int row) {
    return ((row_ptr+row)->nprotmasstof);
  }
  float get_mm_p_pip(int row) {
    return ((row_ptr+row)->mm_p_pip);
  }
  float get_smm_p_pip(int row) {
    return ((row_ptr+row)->smm_p_pip);
  }
  float get_nmm_p_pip(int row) {
    return ((row_ptr+row)->nmm_p_pip);
  }
  float get_mm_p_pip_pim(int row) {
    return ((row_ptr+row)->mm_p_pip_pim);
  }
  float get_smm_p_pip_pim(int row) {
    return ((row_ptr+row)->smm_p_pip_pim);
  }
  float get_nmm_p_pip_pim(int row) {
    return ((row_ptr+row)->nmm_p_pip_pim);
  }
  float get_mm_kp_lambda(int row) {
    return ((row_ptr+row)->mm_kp_lambda);
  }
  float get_smm_kp_lambda(int row) {
    return ((row_ptr+row)->smm_kp_lambda);
  }
  float get_nmm_kp_lambda(int row) {
    return ((row_ptr+row)->nmm_kp_lambda);
  }
  float get_mm_kp_sigma(int row) {
    return ((row_ptr+row)->mm_kp_sigma);
  }
  float get_smm_kp_sigma(int row) {
    return ((row_ptr+row)->smm_kp_sigma);
  }
  float get_nmm_kp_sigma(int row) {
    return ((row_ptr+row)->nmm_kp_sigma);
  }
  float get_mm_pip(int row) {
    return ((row_ptr+row)->mm_pip);
  }
  float get_smm_pip(int row) {
    return ((row_ptr+row)->smm_pip);
  }
  float get_nmm_pip(int row) {
    return ((row_ptr+row)->nmm_pip);
  }
  float get_ResSL1_ave(int row) {
    return ((row_ptr+row)->ResSL1_ave);
  }
  float get_ResSL2_ave(int row) {
    return ((row_ptr+row)->ResSL2_ave);
  }
  float get_ResSL3_ave(int row) {
    return ((row_ptr+row)->ResSL3_ave);
  }
  float get_ResSL4_ave(int row) {
    return ((row_ptr+row)->ResSL4_ave);
  }
  float get_ResSL5_ave(int row) {
    return ((row_ptr+row)->ResSL5_ave);
  }
  float get_ResSL6_ave(int row) {
    return ((row_ptr+row)->ResSL6_ave);
  }
  float get_ResSL1_sig(int row) {
    return ((row_ptr+row)->ResSL1_sig);
  }
  float get_ResSL2_sig(int row) {
    return ((row_ptr+row)->ResSL2_sig);
  }
  float get_ResSL3_sig(int row) {
    return ((row_ptr+row)->ResSL3_sig);
  }
  float get_ResSL4_sig(int row) {
    return ((row_ptr+row)->ResSL4_sig);
  }
  float get_ResSL5_sig(int row) {
    return ((row_ptr+row)->ResSL5_sig);
  }
  float get_ResSL6_sig(int row) {
    return ((row_ptr+row)->ResSL6_sig);
  }
  float get_ResSL1S1_ave(int row) {
    return ((row_ptr+row)->ResSL1S1_ave);
  }
  float get_ResSL1S2_ave(int row) {
    return ((row_ptr+row)->ResSL1S2_ave);
  }
  float get_ResSL1S3_ave(int row) {
    return ((row_ptr+row)->ResSL1S3_ave);
  }
  float get_ResSL1S4_ave(int row) {
    return ((row_ptr+row)->ResSL1S4_ave);
  }
  float get_ResSL1S5_ave(int row) {
    return ((row_ptr+row)->ResSL1S5_ave);
  }
  float get_ResSL1S6_ave(int row) {
    return ((row_ptr+row)->ResSL1S6_ave);
  }
  float get_ResSL1S1_sig(int row) {
    return ((row_ptr+row)->ResSL1S1_sig);
  }
  float get_ResSL1S2_sig(int row) {
    return ((row_ptr+row)->ResSL1S2_sig);
  }
  float get_ResSL1S3_sig(int row) {
    return ((row_ptr+row)->ResSL1S3_sig);
  }
  float get_ResSL1S4_sig(int row) {
    return ((row_ptr+row)->ResSL1S4_sig);
  }
  float get_ResSL1S5_sig(int row) {
    return ((row_ptr+row)->ResSL1S5_sig);
  }
  float get_ResSL1S6_sig(int row) {
    return ((row_ptr+row)->ResSL1S6_sig);
  }
  float get_ResSL2S1_ave(int row) {
    return ((row_ptr+row)->ResSL2S1_ave);
  }
  float get_ResSL2S2_ave(int row) {
    return ((row_ptr+row)->ResSL2S2_ave);
  }
  float get_ResSL2S3_ave(int row) {
    return ((row_ptr+row)->ResSL2S3_ave);
  }
  float get_ResSL2S4_ave(int row) {
    return ((row_ptr+row)->ResSL2S4_ave);
  }
  float get_ResSL2S5_ave(int row) {
    return ((row_ptr+row)->ResSL2S5_ave);
  }
  float get_ResSL2S6_ave(int row) {
    return ((row_ptr+row)->ResSL2S6_ave);
  }
  float get_ResSL2S1_sig(int row) {
    return ((row_ptr+row)->ResSL2S1_sig);
  }
  float get_ResSL2S2_sig(int row) {
    return ((row_ptr+row)->ResSL2S2_sig);
  }
  float get_ResSL2S3_sig(int row) {
    return ((row_ptr+row)->ResSL2S3_sig);
  }
  float get_ResSL2S4_sig(int row) {
    return ((row_ptr+row)->ResSL2S4_sig);
  }
  float get_ResSL2S5_sig(int row) {
    return ((row_ptr+row)->ResSL2S5_sig);
  }
  float get_ResSL2S6_sig(int row) {
    return ((row_ptr+row)->ResSL2S6_sig);
  }
  float get_ResSL3S1_ave(int row) {
    return ((row_ptr+row)->ResSL3S1_ave);
  }
  float get_ResSL3S2_ave(int row) {
    return ((row_ptr+row)->ResSL3S2_ave);
  }
  float get_ResSL3S3_ave(int row) {
    return ((row_ptr+row)->ResSL3S3_ave);
  }
  float get_ResSL3S4_ave(int row) {
    return ((row_ptr+row)->ResSL3S4_ave);
  }
  float get_ResSL3S5_ave(int row) {
    return ((row_ptr+row)->ResSL3S5_ave);
  }
  float get_ResSL3S6_ave(int row) {
    return ((row_ptr+row)->ResSL3S6_ave);
  }
  float get_ResSL3S1_sig(int row) {
    return ((row_ptr+row)->ResSL3S1_sig);
  }
  float get_ResSL3S2_sig(int row) {
    return ((row_ptr+row)->ResSL3S2_sig);
  }
  float get_ResSL3S3_sig(int row) {
    return ((row_ptr+row)->ResSL3S3_sig);
  }
  float get_ResSL3S4_sig(int row) {
    return ((row_ptr+row)->ResSL3S4_sig);
  }
  float get_ResSL3S5_sig(int row) {
    return ((row_ptr+row)->ResSL3S5_sig);
  }
  float get_ResSL3S6_sig(int row) {
    return ((row_ptr+row)->ResSL3S6_sig);
  }
  float get_ResSL4S1_ave(int row) {
    return ((row_ptr+row)->ResSL4S1_ave);
  }
  float get_ResSL4S2_ave(int row) {
    return ((row_ptr+row)->ResSL4S2_ave);
  }
  float get_ResSL4S3_ave(int row) {
    return ((row_ptr+row)->ResSL4S3_ave);
  }
  float get_ResSL4S4_ave(int row) {
    return ((row_ptr+row)->ResSL4S4_ave);
  }
  float get_ResSL4S5_ave(int row) {
    return ((row_ptr+row)->ResSL4S5_ave);
  }
  float get_ResSL4S6_ave(int row) {
    return ((row_ptr+row)->ResSL4S6_ave);
  }
  float get_ResSL4S1_sig(int row) {
    return ((row_ptr+row)->ResSL4S1_sig);
  }
  float get_ResSL4S2_sig(int row) {
    return ((row_ptr+row)->ResSL4S2_sig);
  }
  float get_ResSL4S3_sig(int row) {
    return ((row_ptr+row)->ResSL4S3_sig);
  }
  float get_ResSL4S4_sig(int row) {
    return ((row_ptr+row)->ResSL4S4_sig);
  }
  float get_ResSL4S5_sig(int row) {
    return ((row_ptr+row)->ResSL4S5_sig);
  }
  float get_ResSL4S6_sig(int row) {
    return ((row_ptr+row)->ResSL4S6_sig);
  }
  float get_ResSL5S1_ave(int row) {
    return ((row_ptr+row)->ResSL5S1_ave);
  }
  float get_ResSL5S2_ave(int row) {
    return ((row_ptr+row)->ResSL5S2_ave);
  }
  float get_ResSL5S3_ave(int row) {
    return ((row_ptr+row)->ResSL5S3_ave);
  }
  float get_ResSL5S4_ave(int row) {
    return ((row_ptr+row)->ResSL5S4_ave);
  }
  float get_ResSL5S5_ave(int row) {
    return ((row_ptr+row)->ResSL5S5_ave);
  }
  float get_ResSL5S6_ave(int row) {
    return ((row_ptr+row)->ResSL5S6_ave);
  }
  float get_ResSL5S1_sig(int row) {
    return ((row_ptr+row)->ResSL5S1_sig);
  }
  float get_ResSL5S2_sig(int row) {
    return ((row_ptr+row)->ResSL5S2_sig);
  }
  float get_ResSL5S3_sig(int row) {
    return ((row_ptr+row)->ResSL5S3_sig);
  }
  float get_ResSL5S4_sig(int row) {
    return ((row_ptr+row)->ResSL5S4_sig);
  }
  float get_ResSL5S5_sig(int row) {
    return ((row_ptr+row)->ResSL5S5_sig);
  }
  float get_ResSL5S6_sig(int row) {
    return ((row_ptr+row)->ResSL5S6_sig);
  }
  float get_ResSL6S1_ave(int row) {
    return ((row_ptr+row)->ResSL6S1_ave);
  }
  float get_ResSL6S2_ave(int row) {
    return ((row_ptr+row)->ResSL6S2_ave);
  }
  float get_ResSL6S3_ave(int row) {
    return ((row_ptr+row)->ResSL6S3_ave);
  }
  float get_ResSL6S4_ave(int row) {
    return ((row_ptr+row)->ResSL6S4_ave);
  }
  float get_ResSL6S5_ave(int row) {
    return ((row_ptr+row)->ResSL6S5_ave);
  }
  float get_ResSL6S6_ave(int row) {
    return ((row_ptr+row)->ResSL6S6_ave);
  }
  float get_ResSL6S1_sig(int row) {
    return ((row_ptr+row)->ResSL6S1_sig);
  }
  float get_ResSL6S2_sig(int row) {
    return ((row_ptr+row)->ResSL6S2_sig);
  }
  float get_ResSL6S3_sig(int row) {
    return ((row_ptr+row)->ResSL6S3_sig);
  }
  float get_ResSL6S4_sig(int row) {
    return ((row_ptr+row)->ResSL6S4_sig);
  }
  float get_ResSL6S5_sig(int row) {
    return ((row_ptr+row)->ResSL6S5_sig);
  }
  float get_ResSL6S6_sig(int row) {
    return ((row_ptr+row)->ResSL6S6_sig);
  }
};
...
public:
  ...
  int get_NpipS1(int row) {
    return ((row_ptr+row)->NpipS1);
  }
  int get_NpipS2(int row) {
    return ((row_ptr+row)->NpipS2);
  }
  int get_NpipS3(int row) {
    return ((row_ptr+row)->NpipS3);
  }
  int get_NpipS4(int row) {
    return ((row_ptr+row)->NpipS4);
  }
  int get_NpipS5(int row) {
    return ((row_ptr+row)->NpipS5);
  }
  int get_NpipS6(int row) {
    return ((row_ptr+row)->NpipS6);
  }
  int get_NprotS1(int row) {
    return ((row_ptr+row)->NprotS1);
  }
  int get_NprotS2(int row) {
    return ((row_ptr+row)->NprotS2);
  }
  int get_NprotS3(int row) {
    return ((row_ptr+row)->NprotS3);
  }
  int get_NprotS4(int row) {
    return ((row_ptr+row)->NprotS4);
  }
  int get_NprotS5(int row) {
    return ((row_ptr+row)->NprotS5);
  }
  int get_NprotS6(int row) {
    return ((row_ptr+row)->NprotS6);
  }
  int get_NpimS1(int row) {
    return ((row_ptr+row)->NpimS1);
  }
  int get_NpimS2(int row) {
    return ((row_ptr+row)->NpimS2);
  }
  int get_NpimS3(int row) {
    return ((row_ptr+row)->NpimS3);
  }
  int get_NpimS4(int row) {
    return ((row_ptr+row)->NpimS4);
  }
  int get_NpimS5(int row) {
    return ((row_ptr+row)->NpimS5);
  }
  int get_NpimS6(int row) {
    return ((row_ptr+row)->NpimS6);
  }
  int get_NhbS1(int row) {
    return ((row_ptr+row)->NhbS1);
  }
  int get_NhbS2(int row) {
    return ((row_ptr+row)->NhbS2);
  }
  int get_NhbS3(int row) {
    return ((row_ptr+row)->NhbS3);
  }
  int get_NhbS4(int row) {
    return ((row_ptr+row)->NhbS4);
  }
  int get_NhbS5(int row) {
    return ((row_ptr+row)->NhbS5);
  }
  int get_NhbS6(int row) {
    return ((row_ptr+row)->NhbS6);
  }
  int get_NtbS1(int row) {
    return ((row_ptr+row)->NtbS1);
  }
  int get_NtbS2(int row) {
    return ((row_ptr+row)->NtbS2);
  }
  int get_NtbS3(int row) {
    return ((row_ptr+row)->NtbS3);
  }
  int get_NtbS4(int row) {
    return ((row_ptr+row)->NtbS4);
  }
  int get_NtbS5(int row) {
    return ((row_ptr+row)->NtbS5);
  }
  int get_NtbS6(int row) {
    return ((row_ptr+row)->NtbS6);
  }
  int get_NphotS1(int row) {
    return ((row_ptr+row)->NphotS1);
  }
  int get_NphotS2(int row) {
    return ((row_ptr+row)->NphotS2);
  }
  int get_NphotS3(int row) {
    return ((row_ptr+row)->NphotS3);
  }
  int get_NphotS4(int row) {
    return ((row_ptr+row)->NphotS4);
  }
  int get_NphotS5(int row) {
    return ((row_ptr+row)->NphotS5);
  }
  int get_NphotS6(int row) {
    return ((row_ptr+row)->NphotS6);
  }
  int get_Nhb(int row) {
...
public:
  ...
  float get_p_tot(int row) {
    return ((row_ptr+row)->p_tot);
  }
  float get_x2(int row) {
    return ((row_ptr+row)->x2);
  }
  float get_theta(int row) {
    return ((row_ptr+row)->theta);
  }
  float get_charge(int row) {
    return ((row_ptr+row)->charge);
  }
  float get_dca(int row) {
    return ((row_ptr+row)->dca);
  }
  ...
  float get_vtl(int row) {
    return ((row_ptr+row)->vtl);
  }
  float get_sdist(int row) {
    return ((row_ptr+row)->sdist);
  }
  float get_edist(int row) {
    return ((row_ptr+row)->edist);
  }
  float get_npts(int row) {
    return ((row_ptr+row)->npts);
  }
  float get_r_0(int row) {
    return ((row_ptr+row)->r_0);
  }
};
...
public:
  ...
  int get_B1(int row) {
    return ((row_ptr+row)->B1);
  }
  int get_B2(int row) {
    return ((row_ptr+row)->B2);
  }
  int get_B3(int row) {
    return ((row_ptr+row)->B3);
  }
  int get_B4(int row) {
    return ((row_ptr+row)->B4);
  }
  int get_B5(int row) {
    return ((row_ptr+row)->B5);
  }
  int get_B6(int row) {
    return ((row_ptr+row)->B6);
  }
  int get_B7(int row) {
    return ((row_ptr+row)->B7);
  }
  int get_B8(int row) {
    return ((row_ptr+row)->B8);
  }
  int get_B9(int row) {
    return ((row_ptr+row)->B9);
  }
  int get_B10(int row) {
    return ((row_ptr+row)->B10);
  }
  int get_B11(int row) {
    return ((row_ptr+row)->B11);
  }
  int get_B12(int row) {
    return ((row_ptr+row)->B12);
  }
  int get_B13(int row) {
    return ((row_ptr+row)->B13);
  }
  int get_B14(int row) {
    return ((row_ptr+row)->B14);
  }
  int get_B15(int row) {
    return ((row_ptr+row)->B15);
  }
  int get_B16(int row) {
    return ((row_ptr+row)->B16);
  }
};
...
public:
  ...
  int get_trigger_pattern(int row) {
    return ((row_ptr+row)->trigger_pattern);
  }
  int get_gated_scaler(int row) {
    return ((row_ptr+row)->gated_scaler);
  }
  int get_ungated_scaler(int row) {
    return ((row_ptr+row)->ungated_scaler);
  }
};
...
public:
  ...
  int get_hid(int row) {
    return ((row_ptr+row)->hid);
  }
  float get_hx(int row) {
    return ((row_ptr+row)->hx);
  }
  float get_hy(int row) {
    return ((row_ptr+row)->hy);
  }
  float get_hz(int row) {
    return ((row_ptr+row)->hz);
  }
  float get_hnphe(int row) {
    return ((row_ptr+row)->hnphe);
  }
  float get_htime(int row) {
    return ((row_ptr+row)->htime);
  }
  int get_hstatus(int row) {
    return ((row_ptr+row)->hstatus);
  }
};
...
public:
  ...
  float get_PID(int row) {
    return ((row_ptr+row)->PID);
  }
  float get_X0(int row) {
    return ((row_ptr+row)->X0);
  }
  float get_Y0(int row) {
    return ((row_ptr+row)->Y0);
  }
  float get_Z0(int row) {
    return ((row_ptr+row)->Z0);
  }
  float get_E0(int row) {
    return ((row_ptr+row)->E0);
  }
  float get_Px0(int row) {
    return ((row_ptr+row)->Px0);
  }
  float get_py0(int row) {
    return ((row_ptr+row)->py0);
  }
  float get_Pz0(int row) {
    return ((row_ptr+row)->Pz0);
  }
  float get_q(int row) {
    return ((row_ptr+row)->q);
  }
  float get_X1(int row) {
    return ((row_ptr+row)->X1);
  }
  float get_Y1(int row) {
    return ((row_ptr+row)->Y1);
  }
  float get_Z1(int row) {
    return ((row_ptr+row)->Z1);
  }
  float get_E1(int row) {
    return ((row_ptr+row)->E1);
  }
  float get_Px1(int row) {
    return ((row_ptr+row)->Px1);
  }
  float get_py1(int row) {
    return ((row_ptr+row)->py1);
  }
  float get_Pz1(int row) {
    return ((row_ptr+row)->Pz1);
  }
  float get_R(int row) {
    return ((row_ptr+row)->R);
  }
