...
tpecal_opts::tpecal_opts()
{
	args["LOG_MSG"].args = " >>> TPE Calorimeter";
	...
	args["PROCESS_MIP"].arg  = 0;
	args["PROCESS_MIP"].help = "Process MIP Bos File";
	args["PROCESS_MIP"].name = "Process MIP Bos File";
	args["PROCESS_MIP"].type = 0;
	args["PROCESS_MIP"].ctgr = "control";
	
	args["PROCESS_BEAM"].arg  = 0;
	args["PROCESS_BEAM"].help = "Process Beam On Bos File";
	args["PROCESS_BEAM"].name = "Process Beam On Bos File";
	args["PROCESS_BEAM"].type = 0;
	args["PROCESS_BEAM"].ctgr = "control";
	...
	args["MIN_NEIGHBOR"].arg  = 0.0;
	args["MIN_NEIGHBOR"].help = "Minimum Value of Neighbor to be considered signal";
	args["MIN_NEIGHBOR"].name = "Minimum Value of Neighbor to be considered signal";
	args["MIN_NEIGHBOR"].type = 0;
	args["MIN_NEIGHBOR"].ctgr = "control";

	args["N"].arg  = 0;
	args["N"].help = "Number of Events to Process";
	args["N"].name = "Number of Events to Process";
	args["N"].type = 0;
	args["N"].ctgr = "control";
	
	
	args["LOGY"].arg  = 0;
	args["LOGY"].help = "Set/Unset Logaritmic Scale on y";
	args["LOGY"].name = "Set/Unset Logaritmic Scale on y";
	args["LOGY"].type = 0;
	args["LOGY"].ctgr = "control";
	
}

tpecal_opts::~tpecal_opts(){}

int tpecal_opts::Set(int argc, char **argv)
{
	string arg;
	string com;
	string opt;
