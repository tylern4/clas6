...
c                                                     Make unit numbers less than 100 8/20/01
C
...
c
	...
	if (istat .ne. 0) then
	   write (6,'(/a,a)') ' *** hscan_means - Error reading input file ',infile
	   write (6,'(a,i)') '  *** hscan_means - hropen error istat = ', istat
	endif
c
...
c
	...
	write (6,*) ' *** hscan_means - Too many histograms - redimension idvect'
		Stop ' *** hscan_means - Too many histograms on file'
	endif
c
	answer = 'n'
	do jj=1,nhist
...
c
		   ...
		   write (30,'(a,f14.3,a)') '1   ''p1''     ',0.85*avex,' 10.'
		   write (30,'(a)') '2   ''p2''      40.  1.'
		   write (30,'(a)') '3   ''p3''       1.  0.1'
		   write (30,'(a,f14.3,a)') '4   ''p4''     ',6*xmax,' 10.'
		   write (30,'(a)') '5   ''p5''       0.  0.1'
		   write (30,'(a)') '6   ''p6''       0.  0.01'
		   write (30,'(a)') ' '
c
c			write list file headers
c
			write (30,'(a)') 'TITLE '''//title(1:4*nwt)//''''
			write (30,'(i4,g14.3,a)') npts,sumw, ' Number of Entries'
			write (30,'(g14.9,g14.9,a)') xmi, xma, ' x LIMITS'
			write (30,'(g14.9,a)') avex,' Average x value' 
c
			do j=1,nx
			   call hix (id,j,xlow)
			   x = xlow + hx
