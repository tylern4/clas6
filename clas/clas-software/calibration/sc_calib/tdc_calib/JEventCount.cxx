...
void JBuffer::ReadEventHeader () {
  ...
  cout << endl;
  */
//cout << "xcode = " << xcode << endl;
  // 65 cooked   24, 16  raw, //72 and 64 are new, dunno what this means, but added so it will work (Paul Mattione)
  if (xcode == 64 || xcode == 72 || xcode == 65 || xcode == 24 || xcode == 16) inx+= 11;  /// gack hack
